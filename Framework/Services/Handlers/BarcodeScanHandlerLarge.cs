...
namespace SeedCut.Framework.Services.Handlers
{
    ...
    /// 4. 配对完成后清除就绪标志，准备下一组
    /// </summary>
    public class BarcodeScanHandlerLarge : BarcodeScanHandlerBase
    {
        #region 常量定义

        // PLC信号名称（需与SignalAliasConfig.cs中的别名匹配）
        public override string SIG_TRAY_SCAN_REQUEST => "LargeTray_ScanRequest";

      
        public override string BusyFlag => TrayType + "Busy";

        public override TrayType TrayType => TrayType.Large;
        ...
        public override string[] DependentDevices => new[] { "Scanner_Large" };
